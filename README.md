...
Iolive is a software for displaying Live2D model with face tracking support.
...
Ioface is Iolive's face tracking tools which is built on [OpenCV 3.0.0](https://github.com/opencv/opencv/tree/3.0.0) and IntraFace.
...
Ioface use IntraFace library from [@genshengye](https://github.com/genshengye) in his [repository](https://github.com/genshengye/IntraFace/)
